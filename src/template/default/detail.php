    ...
    <div class="col-md-8">
        ...
        <div class="d-flex mb-4">
            ...
            <div class="flex-fill">
                ...
                <a href="{:$router->buildUrl('/ebcms/store/item', ['plugin_name'=>$plugin['name']])}" class="btn btn-primary float-end">立即安装</a>
                {else}
                <?php $hasnew = version_compare($_installed[$plugin['name']], $plugin['version'], '<'); ?>
                {if $hasnew}
                <a href="{:$router->buildUrl('/ebcms/store/item', ['plugin_name'=>$plugin['name']])}" class="btn btn-warning float-end">可升级</a>
                {else}
                <a href="#" class="btn btn-secondary float-end disabled" role="button" aria-disabled="true">已安装最新版</a>
                {/if}
                {/if}
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active" id="content-tab" data-bs-toggle="tab" href="#content" role="tab" aria-controls="content" aria-selected="true">介绍</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="changelog-tab" data-bs-toggle="tab" href="#changelog" role="tab" aria-controls="changelog" aria-selected="false">更新日志</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="stats-tab" data-bs-toggle="tab" href="#stats" role="tab" aria-controls="stats" aria-selected="false">统计</a>
            </li>
        </ul>
